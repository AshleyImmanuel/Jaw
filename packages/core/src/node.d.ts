...
export type JawNodeType = 'Box' | 'Row' | 'Column' | 'Text' | 'Button' | 'Image' | 'Spacer' | 'Scroll' | 'Fragment';
...
export declare function isTextNode(node: JawNode): node is JawTextNode;
/** Create a raw JawNode (used internally by createElement) */
export declare function createNode(type: JawNodeType | string, props: JawProps, children: ReadonlyArray<JawNode>, key?: string | number): JawNode;
