...
import { serializeRenderPlan, MessageBridge, AndroidRenderer } from '../src/index';
...
describe('Android Renderer', () => {
  ...
  it('MessageBridge handles native messages properly', () => {
    ...
    const nativeCallback = (globalThis as any).__JAW_RECEIVE_FROM_NATIVE__;
